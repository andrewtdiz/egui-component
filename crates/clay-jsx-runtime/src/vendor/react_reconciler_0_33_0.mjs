...
import * as Scheduler from "clay-internal:/scheduler";
const module = { exports: {} };
const exports = module.exports;
const require = (name) => { if (name === "react") return React; if (name === "scheduler") return Scheduler; throw new Error(`Unsupported require: ${name}`); };
{
/**
 * @license React
